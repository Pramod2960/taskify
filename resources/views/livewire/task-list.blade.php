<div class="w-full px-10 h-screen p-6 bg-white rounded text-sm mt-2 mb-10">
    <div class="flex justify-between items-center mb-2">
        ...
        <div class=" flex gap-2 ">
            ...
            <div>
                <input wire:model.live.debounce.300ms="search" placeholder="Search by Title " class=" rounded-lg p-1 px-2 text-sm" />
            </div>
            <div>
                <label for="filterDate" class="mr-2 font-medium">Filter Projects:</label>
                <select class="border rounded px-5 py-1  focus:outline-none focus:ring-2 focus:ring-blue-400" wire:model.live="filter_project">
            ...
            <div>
                ...
                <input type="date" id="filterDate" name="filterDate" wire:model.live='filter_date' class="border rounded px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-400" onchange="filterTasksByDate(this.value)">
            </div>
            <div>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border">
                        <a href="{{ route('task.show', $task->id) }}" wire:navigate class="
   ...
   ">
    ...
    ">
                    ...
                    <td class="px-4 py-1 border text-center text-sm">
                        <span class=" p-2 inline-block px-2 py-1 text-xs font-semibold  rounded-full uppercase
