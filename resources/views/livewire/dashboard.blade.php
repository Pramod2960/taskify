<div class="p-6 bg-gray-100 min-h-screen">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <!-- New Tasks Card -->
        <div class="bg-rose-300 text-white rounded-lg shadow p-6 flex flex-col items-center">
            <div class="text-4xl font-bold">{{ $newCount }}</div>
            <div class="mt-2 text-lg font-medium">New Tasks</div>
        </div>

        <!-- New Pending Card -->
        <div class="bg-red-400 text-purple-50 rounded-lg shadow p-6 flex flex-col items-center">
            <div class="text-4xl font-bold">{{ $pendingTask }}</div>
            <div class="mt-2 text-lg font-medium">Pending Tasks</div>
        </div>

        <!-- Watching Tasks Card -->
        <div class="bg-green-300 text-white rounded-lg shadow p-6 flex flex-col items-center">
