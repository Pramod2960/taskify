...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div class="flex justify-between py-1">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('task.list')" :active="request()->routeIs('task.list')" wire:navigate.hover>
                        Tasks
                    </x-nav-link>
                </div>
                ...
                @hasanyrole('developer|tester|superadmin')
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
